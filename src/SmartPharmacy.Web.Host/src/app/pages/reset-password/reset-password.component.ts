...
export class ResetPasswordPage implements OnInit {
  ...
  resetPasswordFormSubmit(): void {
    ...
    const resetPasswordInputDto = new ResetPasswordInputDto();
    resetPasswordInputDto.init(this.resetForm.value);

    console.log(resetPasswordInputDto);

    this._accountService.resetPassword(resetPasswordInputDto).subscribe(
      () => {
