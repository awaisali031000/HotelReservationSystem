...
{
    public abstract class SmartPharmacyWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SmartPharmacyWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SmartPharmacyWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SmartPharmacyDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SmartPharmacyDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SmartPharmacyDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SmartPharmacyDbContext, Task<T>> func)
        {
            T result;
